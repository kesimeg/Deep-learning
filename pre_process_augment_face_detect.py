...
for element in class_files:
    ...
    for image_name in files:
        ...
        for i in range(0,number_of_copies):
                ...
                cv2.imwrite("./augmented_data/processed/"+element+"/"+str(i)+image_name,aug[0][i]*255) #has to be converted to 0-255
                cv2.imwrite("./augmented_data/lbp/"+element+"/"+str(i)+image_name,aug[1][i]*255)
